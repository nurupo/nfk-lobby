    ...
    : QDialog(parent)
{
    ...
    filterGametypeDmCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getGameTypeFilter()[Game::DM]);
    filterGametypeTdmCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getGameTypeFilter()[Game::TDM]);
    filterGametypeCtfCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getGameTypeFilter()[Game::CTF]);
    filterGametypeDomCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getGameTypeFilter()[Game::DOM]);
    filterGametypePracCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getGameTypeFilter()[Game::PRAC]);
    filterGametypeRailCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getGameTypeFilter()[Game::RAIL]);
    ...
    filterPlayersFullCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getHideOnFullFilter());
    filterPlayersEmptyCheckbox->setChecked(parent->getPlanetTreeProxyModel()->getHideOnEmptyFilter());
